...
export interface IHealthCheckClient {
    readiness(offset: number | undefined, limit: number | undefined): Observable<FileResponse>;
    liveness(offset: number | undefined, limit: number | undefined): Observable<FileResponse>;
}
...
export class HealthCheckClient implements IHealthCheckClient {
    ...
    readiness(offset: number | undefined, limit: number | undefined): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/healthcheck/readiness?";
        if (offset === null)
            throw new Error("The parameter 'offset' cannot be null.");
        else if (offset !== undefined)
            url_ += "Offset=" + encodeURIComponent("" + offset) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processReadiness(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processReadiness(response_ as any);
                } catch (e) {
    ...
    protected processReadiness(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    liveness(offset: number | undefined, limit: number | undefined): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/healthcheck/liveness?";
        if (offset === null)
            throw new Error("The parameter 'offset' cannot be null.");
        else if (offset !== undefined)
            url_ += "Offset=" + encodeURIComponent("" + offset) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLiveness(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLiveness(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    protected processLiveness(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
