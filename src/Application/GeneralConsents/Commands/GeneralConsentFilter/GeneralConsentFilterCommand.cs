    ...
    public async Task<List<GeneralConsent>> Handle(GeneralConsentFilterCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (request.GeneralConsentFilterKey != null)
            {
                ...
                {
                    query = query.Where(p => p.IdCardNumber == request.GeneralConsentFilterKey.IdCardNumber).ToList();
                ...
                {
                    query = query.Where(p => p.FullName == request.GeneralConsentFilterKey.FullName).ToList(); ;
                ...
                {
                    query = query.Where(p => p.PhoneNumber == request.GeneralConsentFilterKey.PhoneNumber).ToList(); ;
                ...
                {
                    query = query.Where(p => p.Email == request.GeneralConsentFilterKey.Email).ToList(); ;
                ...
                {
                    query = query.Where(p => p.Uid == request.GeneralConsentFilterKey.Uid).ToList(); ;
                ...
                if (request.GeneralConsentFilterKey.StartDate != null)
                {
                    ...
                    query = query.Where(p => DateTimeOffset.Parse(p.ConsentDateTime) >= startDateVal).ToList();
                ...
                if (request.GeneralConsentFilterKey.EndDate != null)
                {
                    ...
                    query = query.Where(p => DateTimeOffset.Parse(p.ConsentDateTime) <= endDateVal).ToList();
